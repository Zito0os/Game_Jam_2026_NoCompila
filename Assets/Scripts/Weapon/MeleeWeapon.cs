...
public class MeleeWeapon : MonoBehaviour
{
    ...
    public LayerMask enemyLayers;        // asigna la layer Enemy
    ...
    void DoMeleeHit()
    {
        ...
        if (hits.Length == 0)
        {
            ...
            if (Physics.Raycast(origin, forward, out RaycastHit hit, range, enemyLayers, QueryTriggerInteraction.Ignore))
            {
